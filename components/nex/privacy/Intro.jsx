      ...
      <div className="container">
        <div className="sec-head text-center">
          <div className="row justify-content-start">
            ...
            <div className="col-lg-12 mt-15">
              <div>
                <h4 className="mb-15  text-left">Payment and Billing Terms</h4>

                <p className="text-left">
                  For our paid services, payment terms will be outlined in your
                  service agreement. Payment is due upon receipt of invoice
                  unless otherwise specified. Failure to make timely payments
